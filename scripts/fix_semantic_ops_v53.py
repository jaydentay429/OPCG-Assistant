#!/usr/bin/env python3
"""Deterministic semantic fixes v53: high missing-gate / wrong-target / missing-op / gate batch.
...
OUT_IDS = ROOT / "meta" / "logs" / "ops_v53_fixed_ids.txt"
REBUILDS_PATH = ROOT / "meta" / "logs" / "ops_v53_rebuilds.json"
