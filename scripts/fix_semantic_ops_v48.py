#!/usr/bin/env python3
"""Deterministic semantic fixes v48: high wrong-target / missing-op / gate batch.
...
OUT_IDS = ROOT / "meta" / "logs" / "ops_v48_fixed_ids.txt"
REBUILDS_PATH = ROOT / "meta" / "logs" / "ops_v48_rebuilds.json"
