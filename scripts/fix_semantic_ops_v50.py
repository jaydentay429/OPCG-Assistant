#!/usr/bin/env python3
"""Deterministic semantic fixes v50: high wrong-target / missing-op / gate batch.
...
OUT_IDS = ROOT / "meta" / "logs" / "ops_v50_fixed_ids.txt"
REBUILDS_PATH = ROOT / "meta" / "logs" / "ops_v50_rebuilds.json"
