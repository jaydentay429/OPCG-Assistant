#!/usr/bin/env python3
"""Deterministic semantic fixes v47: high wrong-target / missing-op / gate batch.
...
OUT_IDS = ROOT / "meta" / "logs" / "ops_v47_fixed_ids.txt"
REBUILDS_PATH = ROOT / "meta" / "logs" / "ops_v47_rebuilds.json"
